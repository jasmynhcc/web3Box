...
This is a decentralized application built on the Ethereum/Polygon blockchain, it works like Dropbox or Google Drive by allowing users to securely store their files on the blockchain using IPFS/Filecoin Technology
...
3. Clone the repo:
   ```sh
   git clone https://github.com/jasmynhcc/web3Box.git
   cd web3Box
   ```
3. Install Ganache:
...
### Contracts
   ...
   In the web3Box folder you'll find a directory contracts, all the smart contracts build in brownie are stored there. The FileStorage contract is the core of this application, it plays the role of the backend and has the following features:
...
### Scripts
   ...
   In the web3Box folder you'll find a directory scripts, it contain all the python code for deploying your contracts and also some useful functions
 ...
 ### Testing
   ...
   In your web3Box folder you'll find a directory tests, it contain all the python code used for testing the smart contract functionalities
